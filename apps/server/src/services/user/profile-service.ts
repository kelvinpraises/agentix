...
// TypeScript interfaces for getUserProfileWithSectors return type
...
export interface UserProfileWithSectors {
  id: number;
  email: string;
  created_at: Date;
...
export const profileService = {
  ...
  async getUserProfileWithSectors(userId: number): Promise<UserProfileWithSectors | null> {
    ...
    const sectors = await db
      ...
      .select([
        ...
        "threads.provider_id as thread_provider",
